/**
 * HERA - Storage Manager
 * Gerencia dados com localStorage e funcionalidades avançadas
 */

class Storage {
    constructor() {
        this.key = 'hera_pro_data';
        this.autocompleteKey = 'hera_autocomplete';
        this.configKey = 'hera_config';
        this.init();
    }
    ...
    exportBackup() {
        ...
        a.href = url;
        a.download = `hera_backup_${new Date().toISOString().split('T')[0]}.json`;
